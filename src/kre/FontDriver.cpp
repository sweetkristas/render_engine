...
namespace KRE
{
	...
	FontRenderablePtr FontHandle::renderText(FontRenderablePtr r, const std::string& text)
	{
		auto path = getGlyphPath(text);
		return createRenderableFromPath(r, text, path);
	}
